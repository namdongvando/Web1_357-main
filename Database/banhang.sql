...
-- Thời gian đã tạo: Th6 28, 2022 lúc 08:21 PM
...
(1, 'Nguyen Văn Tèo', 'teonv', 'soaivong01@gmail.com', '036669741', '7e240de74fb1ed08fa08d38063f6a6a91462a815', 'hcm', '1', '2', '18'),
...
(4, 'TopBanner', ' <h1>Special Offer!</h1>\r\n            <h2>Additional 50% OFF For Men &amp; Women Clothings</h2>\r\n            <span>This offer is for online only 7PM to middnight ends in 30th July 2015</span>\r\n            <span class=\"btn-close\"></span>', 0, '/public/banner/20.png', '#', 'TopBanner');
...
--
-- Cấu trúc bảng cho bảng `nn_loaitin`
--

DROP TABLE IF EXISTS `nn_loaitin`;
CREATE TABLE IF NOT EXISTS `nn_loaitin` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` text NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `nn_loaitin`
--

INSERT INTO `nn_loaitin` (`Id`, `Name`, `Description`, `Alias`, `Parents`) VALUES
(1, 'Thể Thao', 'Thể Thao', 'the-thao', 0),
(2, 'abc', 'abc', 'abc', 0),
(3, 'abc', 'abc', 'abc', 0),
(4, 'abcaaaa', 'abcaaaaaaaa', 'abcaaaa', 0),
(5, 'abcaaaaaaaaaa', 'abcaaaaaaaaaaaaaaa', 'abcaaaaaaaaaa', 0),
(6, '2222222', '3333asdasdas\nddas', '2222222', 0),
(7, '2222222aaaa', '3333asdasdas\nddas', '2222222aaaa', 0),
(8, '33333333', '222\n2333333333333', '33333333', 0),
(9, '33333333', '222\n2333333333333', '33333333', 0),
(10, 'asdasdas', 'sdsada', 'asdasdas', 0),
(11, 'asdasdasasdasd', 'sdsadaasdas', 'asdasdasasdasd', 0);
...
(1, 'Account', '/users/', 'MenuTopHeader', 0, 'fa fa-user', 0),
(2, 'Wishlist', '/', 'MenuTopHeader', 0, 'fa fa-star', 0),
(3, 'Checkout', '/cart/', 'MenuTopHeader', 1, 'fa fa-crosshairs', 0),
(4, 'Trang Chủ', '/', 'FooterMenu', 0, '', 0),
(5, 'Trang Chủ', '/', 'MainMenu', 0, '', 0),
(6, 'Sản Phẩm', '#', 'MainMenu', 1, '', 0),
(7, 'Giới thiệu', '/index/pages/1', 'MainMenu', 2, '', 0),
(8, 'Liên Hệ', '/index/pages/2', 'MainMenu', 3, '', 0),
...
(17, 'OrderStatus', 'Tình Trạng Đơn Hàng', 'OrderStatus', 'OrderStatusType'),
(18, '1', 'Mới Đặt', 'Mới Đặt Hàng', 'OrderStatus'),
(19, '2', 'Đơn Hàng Thành Công', 'Đơn Hàng Thành Công', 'OrderStatus'),
(20, '3', 'Hủy Đơn Hàng Phía Khách Hàng', 'Hủy Đơn Hàng Phía Khách Hàng', 'OrderStatus'),
(21, '4', 'Hủy Đơn Hàng Phía Công Ty', 'Hủy Đơn Hàng Phía Công Ty', 'OrderStatus'),
(22, 'TopBanner', 'TopBanner', 'Top banner', 'BannerGroupName');
...
--
-- Đang đổ dữ liệu cho bảng `nn_order`
--

INSERT INTO `nn_order` (`Id`, `UserId`, `AddressId`, `Phone`, `Note`, `TotalPrice`, `CountProduct`, `DateTransfer`, `DateCreate`, `Status`, `PaymentStatus`) VALUES
('Thu11-220609-1', 1, 0, '036669741', '', '123135435', 2, '2022-06-10', '2022-06-09', 3, 1),
('Thu11-220609-2', 1, 0, '036669741', '', '123135435', 2, '2022-06-10', '2022-06-09', 3, 1),
('Thu12-20220616-1', 1, 0, '036669741', '', '125230768', 4, '2022-06-17', '2022-06-16', 1, 1),
('Thu12-20220616-2', 1, 0, '036669741', '', '125230768', 4, '2022-06-17', '2022-06-16', 1, 1),
('Thu12-220609-3', 1, 0, '036669741', '', '246258558', 2, '2022-06-10', '2022-06-09', 1, 1),
('Tue14-20220614-1', 1, 0, '036669741', '', '324234', 1, '2022-06-15', '2022-06-14', 1, 1),
('Tue14-20220614-2', 1, 0, '036669741', '', '3252340', 2, '2022-06-15', '2022-06-14', 1, 1),
('Tue14-220607-1', 1, 0, '036669741', '', '123135435', 2, '2022-06-08', '2022-06-07', 3, 1),
('Tue14-220607-2', 1, 0, '036669741', '', '123135435', 2, '2022-06-08', '2022-06-07', 1, 1);
...
--
-- Đang đổ dữ liệu cho bảng `nn_order_detail`
--

INSERT INTO `nn_order_detail` (`Id`, `IdOrder`, `IdProduct`, `Numbers`, `Price`) VALUES
(3, 'Tue14-220607-1', 16, 1, '123123123'),
(4, 'Tue14-220607-1', 15, 1, '12312'),
(5, 'Tue14-220607-2', 16, 1, '123123123'),
(6, 'Tue14-220607-2', 15, 1, '12312'),
(7, 'Thu11-220609-1', 16, 1, '123123123'),
(8, 'Thu11-220609-1', 15, 1, '12312'),
(9, 'Thu11-220609-2', 16, 1, '123123123'),
(10, 'Thu11-220609-2', 15, 1, '12312'),
(11, 'Thu12-220609-3', 16, 2, '123123123'),
(12, 'Thu12-220609-3', 15, 1, '12312'),
(13, 'Tue14-20220614-1', 8, 1, '324234'),
(14, 'Tue14-20220614-2', 8, 10, '324234'),
(15, 'Tue14-20220614-2', 3, 1, '10000'),
(16, 'Thu12-20220616-1', 16, 1, '123123123'),
(17, 'Thu12-20220616-1', 11, 5, '23423'),
(18, 'Thu12-20220616-1', 15, 30, '12312'),
(19, 'Thu12-20220616-1', 8, 5, '324234'),
(20, 'Thu12-20220616-2', 16, 1, '123123123'),
(21, 'Thu12-20220616-2', 11, 5, '23423'),
(22, 'Thu12-20220616-2', 15, 30, '12312'),
(23, 'Thu12-20220616-2', 8, 5, '324234');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nn_pages`
--

DROP TABLE IF EXISTS `nn_pages`;
CREATE TABLE IF NOT EXISTS `nn_pages` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Name` text NOT NULL,
  `Des` text,
  `Keyword` text,
  ...
  `RecUpdateDate` datetime NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `nn_pages`
--

INSERT INTO `nn_pages` (`Id`, `Name`, `Des`, `Keyword`, `Alias`, `Content`, `Lang`, `Images`, `RecCreateDate`, `RecUpdateDate`, `User`, `isDelete`) VALUES
(1, 'Giới thiệu', 'dasa', 'das', 'gioi-thieu', '&lt;p&gt;&lt;img alt=&quot;&quot; src=&quot;/public/img/images/Q0005.jpg&quot; style=&quot;height:500px; width:500px&quot; /&gt;sasdas&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;img alt=&quot;&quot; src=&quot;/public/img/images/Q000_7.jpg&quot; style=&quot;height:500px; width:500px&quot; /&gt;&lt;/p&gt;\r\n\r\n&lt;div class=&quot;ddict_div&quot; style=&quot;top: 700.213px; max-width: 1366.36px; left: 653.182px;&quot;&gt;&lt;img class=&quot;ddict_audio&quot; src=&quot;chrome-extension://bpggmmljdiliancllaapiggllnkbjocb/img/audio.png&quot; /&gt;\r\n&lt;p&gt;sda a&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;S&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;da&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;d&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;một&lt;/p&gt;\r\n&lt;/div&gt;\r\n', 'vi', '/public/img/images/dat-hang-thanh-cong.jpg', '2022-06-16 14:32:55', '2022-06-18 13:55:45', 1, 1),
(2, 'Liên hệ', 'asda', 'asd', 'lien-he', '&lt;p&gt;&amp;nbsp; &amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;iframe height=&quot;450&quot; src=&quot;https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.4139426460865!2d106.682633315284!3d10.77957426208208!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752f2f79ca66c5%3A0x3c18c960b7a9acce!2sNhat%20Nghe%20Education%20JSC!5e0!3m2!1svi!2s!4v1655557917774!5m2!1svi!2s&quot; style=&quot;border:0;&quot; width=&quot;600&quot;&gt;&lt;/iframe&gt;&lt;/p&gt;\r\n', 'vi', '', '2022-06-16 14:33:18', '2022-06-18 13:26:10', 1, 1);
...
(1, 'iphone-13-pro-masdas', 3, 'iPhone 13 Pro Max 128GB Chính hãng VN/A (Mới - Chưa kích hoạt)', 'asdas', '20000000', 'asd', 'sdas', '&lt;p&gt;asdasdasd&lt;/p&gt;\r\n\r\n&lt;p&gt;as&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p style=&quot;text-align: center;&quot;&gt;&lt;img alt=&quot;&quot; src=&quot;/public/img/images/Banner.jpg&quot; style=&quot;height:225px; width:600px&quot; /&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;da&lt;/p&gt;\r\n\r\n&lt;p&gt;s&lt;/p&gt;\r\n\r\n&lt;p&gt;da&lt;/p&gt;\r\n\r\n&lt;p&gt;sdas&lt;/p&gt;\r\n', '/public/upload/7.png', '20000000', 1),
...
(5, 'ThemeName', 'ThemeName', 'Eshopper');
...
(1, 'Nguyen Văn Tèo aaaaa', 'teonv', 'teonguyen@gmail.com', '036669741', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 'hcm', '32', '36', '79100');
